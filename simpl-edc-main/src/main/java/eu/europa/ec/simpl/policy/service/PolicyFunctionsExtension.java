...
import eu.europa.ec.simpl.policy.function.ConsumptionConstraintFunction;
import eu.europa.ec.simpl.policy.function.LocationConstraintFunction;
...
public class PolicyFunctionsExtension implements ServiceExtension {
    ...
    private static final String CONSUMPTION_CONSTRAINT_KEY = EDC_NAMESPACE + "consumption";
    ...
    public void initialize(ServiceExtensionContext context) {
        ...
        ruleBindingRegistry.bind(CONSUMPTION_CONSTRAINT_KEY, NEGOTIATION_SCOPE);
        ...
        policyEngine.registerFunction(ContractNegotiationPolicyContext.class, Permission.class, CONSUMPTION_CONSTRAINT_KEY, new ConsumptionConstraintFunction(monitor));
    }
}
